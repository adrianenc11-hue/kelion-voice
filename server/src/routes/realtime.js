...
- On greetings (bună, salut, hello, etc.), respond with the correct time-appropriate greeting only. Do NOT call weather, location, monitor, or other tools unless the user explicitly asks for weather, location, route, nearby places, or an action.
...
const KELION_TOOLS = [
  ...
  { name: 'hardware_manager', description: "Verifică disponibilitatea punții native pentru hardware. Controlul direct al perifericelor cere o aplicație desktop/bridge separată; camera și locația din browser folosesc tool-urile dedicate.", properties: { action: { type: 'string', description: "'connect', 'disconnect', or 'configure'." }, device: { type: 'string', description: "Device name or type." } }, required: ['action', 'device'] },
  { name: 'cloud_manager', description: "Acces cloud limitat la Google Drive search/list prin integrarea Google conectată. Dropbox, OneDrive și write nu sunt active fără conector dedicat.", properties: { action: { type: 'string', description: "'list', 'search', 'read', or 'write'." }, provider: { type: 'string', description: "'gdrive' (active); Dropbox/OneDrive are reported unavailable unless connected later." }, path: { type: 'string', description: "Search query or file/folder hint." } }, required: ['action', 'provider'] },
  ...
  { name: 'devops_toolkit', description: "Gestionează flux Git/GitHub conectat: informații repo, listare/citire fișiere, creare PR și listare/închidere PR. Merge-ul nu se execută automat; PR-ul rămâne pentru review manual.", properties: { action: { type: 'string', description: "'repo_info', 'list_files', 'read_file', 'create_pr', or 'manage_prs'." }, repo: { type: 'string', description: "Repository slug (e.g. owner/name)." }, branch: { type: 'string', description: "Branch name." }, path: { type: 'string', description: "Path to file (for read_file)." }, title: { type: 'string', description: "PR title." }, body: { type: 'string', description: "PR body/description." }, pr_action: { type: 'string', description: "'list' or 'close' (for manage_prs)." }, issue_number: { type: 'integer', description: "PR number (for manage_prs)." } }, required: ['action'] },
